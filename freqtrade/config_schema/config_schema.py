            ...
            "properties": {
                ...
                "oanda_token": {
                    "description": (
                        ...
                        f"{__VIA_ENV} FREQTRADE__EXCHANGE__OANDA_TOKEN"
                    ),
                    "type": ["string", "null"],
                },
                "key": {
                ...
                "oanda_environment": {
                    "description": "OANDA API environment.",
                    "type": "string",
                    "enum": ["practice", "live"],
                    "default": "practice",
                },
                "oanda_risk_fraction": {
                    "description": "Fraction of account equity risked per trade.",
                    "type": "number",
                    "exclusiveMinimum": 0,
                    "exclusiveMaximum": 1,
                    "default": 0.01,
                },
                "oanda_execution_mode": {
                    "description": "OANDA execution mode; live requires separate confirmation.",
                    "type": "string",
                    "enum": ["backtest", "hyperopt", "dry_run", "practice", "live"],
                    "default": "dry_run",
                },
                "oanda_transaction_cursor_path": {
                    "description": "File used to resume OANDA transaction streaming after restart.",
                    "type": "string",
                    "minLength": 1,
                    "default": "user_data/oanda/transaction_cursor.json",
                },
                "wallet_address": {
                    "description": (
